...
export function ThreeDCardDemo() {
  return (
    <div className="grid sm:grid-cols-1  lg:grid-cols-2 mt-20 space-x-10 max-[500px]:mt-[80rem]">
      <CardContainer className="inter-var ">
        <CardBody
          className="bg-zinc-50 relative group/card  dark:hover:shadow-2xl dark:hover:shadow-rose-500/[0.1] dark:bg-black dark:border-white/[0.2] border-black/[0.1]  
      max-[500px]:w-[15rem] min-[510px]:w-auto min-[510px]:h-auto rounded-xl p-6 border  "
        >
          <CardItem
            translateZ="50"
